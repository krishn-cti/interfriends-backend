...
<body>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="border: 1px solid #ddd;width: 600px;">
                    <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="bodycopy" style="text-align:left;">
                                        ...
                                        <h3 style="text-align: left;"> <strong>Dear <?php echo $sendername; ?>,</strong> </h3>
                                        <h5 style="text-align: left; line-height: 20px;font-weight: 500;" class="ct_line_space"><?php echo $message; ?></h5>
                                        <?php
                                        if (!empty($useremail)) { ?>
                                            <h4 style="text-align:left">Email: <span style="color:#c00;"><?= $useremail; ?></span></h4>
                                        <?php  }
                                        ?>
                                        <p>Thanks & Regards</p>
                                        <p>Interfriends Membership Relations</p>
                                    </td>
                                </tr>
